(() => {
  ...
  var Carousel = class {
    constructor(element) {
      this.elements = {
        ...
        previous: null,
        // generated in #createControl
        next: null,
        // generated in #createControl
        pagination: null
        // generated in #createPagination
      };
      this.current = void 0;
      this.hasIntersected = /* @__PURE__ */ new Set();
    ...
    #createObservers() {
      ...
      this.mutation_observer = new MutationObserver((mutationList, observer) => {
        mutationList.filter((x) => x.removedNodes.length > 0).forEach((mutation) => {
          [...mutation.removedNodes].filter((x) => x.querySelector(".gui-carousel") === this.elements.root).forEach((removedEl) => {
            this.#unlisten();
          });
        });
      });
    ...
    #initializeState() {
      const startIndex = this.elements.root.hasAttribute("carousel-start") ? this.elements.root.getAttribute("carousel-start") - 1 : 0;
    ...
    #handleScrollStart() {
      if (this.elements.root.hasAttribute("carousel-start")) {
        ...
        this.elements.snaps.forEach((snap) => snap.style.scrollSnapAlign = "unset");
        ...
        startElement.addEventListener("animationend", (e) => {
          ...
          this.elements.snaps.forEach((snap) => snap.style.scrollSnapAlign = null);
        }, { once: true });
      }
    }
    #handlePaginate(e) {
  ...
  // node_modules/scrollyfills/dist/scrollyfills.modern.js
